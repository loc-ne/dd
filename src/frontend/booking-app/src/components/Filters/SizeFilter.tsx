...
export default function SizeFilter({ 
  ...
  return (
    <div className="relative">
        ...
        <>
          ...
          <div className="absolute top-full left-0 mt-2 w-80 bg-white rounded border border-gray-300 shadow-lg z-50">
            ...
            <div className="px-4 py-3 border-b border-gray-200">
              <h3 className="text-sm font-semibold text-gray-900">Diện tích phòng</h3>
            </div>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="relative pt-2 pb-6">
                ...
                {/* Slider Container - Căn giữa thumbs */}
      ...
      {/* Custom CSS - Thumbs căn giữa track */}
      <style jsx>{`
        .range-slider {
          position: absolute;
          width: 100%;
